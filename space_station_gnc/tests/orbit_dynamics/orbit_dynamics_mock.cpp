...
public:
        ...
        : Node("orbit_dynamics_mock_node")
    {
        ...
        pub_attitude_  = this->create_publisher<geometry_msgs::msg::Quaternion>("gnc/attitude_LVLH", 10);
        pub_thruster_  = this->create_publisher<std_msgs::msg::Float32MultiArray>("gnc/bias_thruster_cmd", 10);
...
private:
    void publish_mock_data()
    {
        ...
        RCLCPP_INFO(this->get_logger(), "Published mock messages.");
    }
